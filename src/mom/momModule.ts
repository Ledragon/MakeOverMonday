...
import { register as register26 } from './26/state';
import { register as register28 } from './28/state';
import { register as register29 } from './29/state';
...
register26(momModule);
register28(momModule);
register29(momModule);
